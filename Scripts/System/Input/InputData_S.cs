...
public struct InputData_S
{
    ...
    public float TriggerRightValue(float deadZone)
    {
        ...
        {
            //値更新
            value = Gamepad.current.rightTrigger.ReadValue();
        }
    ...
    public float TriggerLeftValue(float deadZone)
    {
        ...
        {
            //値更新
            value = Gamepad.current.leftTrigger.ReadValue();
        }
    ...
    {
        if (Gamepad.current.rightTrigger.wasReleasedThisFrame) { return true; }
